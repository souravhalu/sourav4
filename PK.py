...
TOKEN = '7518044545:AAEWkQKQvzzDvxSBBqNWd9PonODM6TitQVU'  # Replace with your actual bot token
ADMIN_IDS = [7086729173]  # Added new admin ID
CHANNEL_ID = '-1002318100736'  # Replace with your specific channel or group ID
# Initialize the bot
...
def welcome_start(message):
    ...
    bot.send_message(
            message.chat.id,
            f"👋🏻Welcome {user_name}.\n\n"
            f"[➖ 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 𝗧𝗢 𝗝𝗢𝗜𝗡 ➖](https://t.me/Chhotuddosteam)\n\n"    
...
def info(message):
    info_text = (
        "ℹ️ *Bot Information*\n\n"
        "Version: 3.0\n"
        "Developed And Design by: @Harsh_AKM\n"
...
def reset_attack_limit(message):
    owner_id = 7086729173  # Replace with the actual owner ID
...
FEEDBACK_CHANNEL_ID = "-1002304254676"  # Replace with your actual feedback channel ID
