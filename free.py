...
# TELEGRAM BOT TOKEN
bot = telebot.TeleBot('7781146852:AAEP7F8uNS896REuZcdaX179Ksxajar7rNc')

# GROUP AND CHANNEL DETAILS
GROUP_ID = "-1002628629368"
CHANNEL_USERNAME = "@souravhalder009"
SCREENSHOT_CHANNEL = "@souravhalder009"
ADMINS = [6460304861]
...
def handle_attack(message):
    ...
    if message.chat.id != int(GROUP_ID):
        bot.reply_to(message, "🚫 𝗬𝗘𝗛𝗔 𝗡𝗔𝗛𝗜 𝗖𝗛𝗔𝗟𝗘𝗚𝗔 𝗕𝗥𝗢  @souravhalder009 𝗚𝗥𝗢𝗨𝗣 𝗝𝗢𝗜𝗡 𝗞𝗥! ❌")
        return
    ...
    if time_duration > 151:
        bot.reply_to(message, "🚫 151𝙎 𝙎𝙀 𝙕𝙔𝘼𝘿𝘼 𝘼𝙇𝙇𝙊𝙒𝙀𝘿 𝙉𝘼𝙃𝙄 𝙃𝘼𝙄!")
        return
