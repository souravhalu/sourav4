...
bot = telebot.TeleBot('7725999486:AAEkC2QTTYUFunOiWE44TyFXMncs8m2TCao')

# Admin user IDs
admin_id = ["7086729173 , 7663163950"]
...
def welcome_start(message):
    if message is not None:
        ...
        response = (
            "*🔥 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗧𝗛𝗘 𝗠𝗔𝗙𝗜𝗔 𝗗𝗗𝗢𝗦 𝗕𝗢𝗧! 🔥*\n\n"
            "*𝗜𝗙 𝗬𝗢𝗨 𝗪𝗔𝗡𝗧 𝗧𝗢 𝗗𝗢 𝗔 𝗣𝗢𝗪𝗘𝗥𝗙𝗨𝗟 𝗔𝗧𝗧𝗔𝗖𝗞 𝗣𝗟𝗘𝗔𝗦𝗘 𝗨𝗦𝗘 /bgmi <ip> <port> <duration>*\n"
            "*𝗨𝗦𝗘 /help 𝗧𝗢 𝗚𝗘𝗧 𝗧𝗛𝗘 𝗥𝗨𝗟𝗘𝗦
.*"
        )
        bot.reply_to(message, response)
